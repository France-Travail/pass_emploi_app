            ...
            child: Stack(
              children: [
                Positioned(
                  top: 0,
                  right: 0,
                  child: ExcludeSemantics(child: SvgPicture.asset(Drawables.iaFtIllustration)),
                ),
                Column(
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          Expanded(
            child: Text(Strings.topDemarchesHint, style: TextStyles.textSRegular(color: contentColor)),
          ),
          Container(
