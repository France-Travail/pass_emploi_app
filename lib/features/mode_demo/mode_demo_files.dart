...
String? getDemoFileName(String url, String query) {
  ...
  if (url.endsWith('/offres-immersion') || url.endsWith('/offres-immersion/v3')) return 'offres_immersion_list';
  ...
  if (url.contains('/offres-immersion/v3/')) return 'immersion_detail';
