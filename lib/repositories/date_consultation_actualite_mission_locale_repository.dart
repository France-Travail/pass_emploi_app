...
class DateConsultationActualiteMissionLocaleRepository {
  final FlutterSecureStorage _preferences;

  static const _key = 'dateDerniereConsultationActualiteMissionLocale';

  DateConsultationActualiteMissionLocaleRepository(this._preferences);
